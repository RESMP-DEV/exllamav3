# Review guidance for RESMP-DEV/exllamav3
...
- Review RESMP-DEV/exllamav3 as the source of truth for An optimized quantization and inference library for running LLMs locally on modern consumer-class GPUs.
